...
> [https://github.com/Vusys/tetryon/security/advisories/new](https://github.com/Vusys/tetryon/security/advisories/new)
...
- A minimal reproduction (OS, Firefox version, and a failing test where possible).
...
- The application under test — Tetryon drives the browser; it does not vouch for the site you point it at.
